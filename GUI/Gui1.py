...
def start(event):
    ...
    if song["song_id"] == 2:
        ...
        recommend = Label(frm, text='Recommended songs:')
        recommend.pack(side=TOP)
        recommend1 = Label(frm, text='Mama Said - Lukas Graham')
        recommend1.pack(side=TOP)
        recommend2 = Label(frm, text='See You Again - Wiz Khalifa ft. Charlie Puth')
        recommend2.pack(side=TOP)
    if song["song_id"] == 3:
        id = Label(frm, text='Your song:  ' + song['song_name'])
        id.pack(side=TOP)
    ...
    if song["song_id"] == 8:
        ...
        recommend = Label(frm, text='Recommended songs:')
        recommend.pack(side=TOP)
        recommend1 = Label(frm, text='Uptown Funk - Mark Ronson ft. Bruno Mars')
        recommend1.pack(side=TOP)
    ...
    if song["song_id"] == 10:
        ...
        recommend = Label(frm, text='Recommended songs:')
        recommend.pack(side=TOP)
        recommend1 = Label(frm, text='When I Was Your Man - Bruno Mars')
        recommend1.pack(side=TOP)
        recommend2 = Label(frm, text="It Will Rain - Bruno Mars")
        recommend2.pack(side=TOP)
    if song["song_id"] == 11:
        id = Label(frm, text='Your song:  ' + song['song_name'])
        id.pack(side=TOP)
        recommend = Label(frm, text='Recommended songs:')
        recommend.pack(side=TOP)
        recommend1 = Label(frm, text='How Deep - Calvin Harris & Disciples')
        recommend1.pack(side=TOP)
        recommend2 = Label(frm, text="Stitches - Shawn Mendes")
        recommend2.pack(side=TOP)
    if song["song_id"] == 12:
        id = Label(frm, text='Your song:  ' + song['song_name'])
        id.pack(side=TOP)
        ...
        recommend1.pack(side=TOP)
        recommend2 = Label(frm, text="Do You Mind - DJ Khaled ft. Nicki Minaj")
        recommend2.pack(side=TOP)
    if song["song_id"] == 13:
        id = Label(frm, text='Your song:  ' + song['song_name'])
        id.pack(side=TOP)
        ...
        recommend1.pack(side=TOP)
        recommend2 = Label(frm, text="Titanium - David Guetta ft. Sia")
        recommend2.pack(side=TOP)
    if song["song_id"] == 14:
        id = Label(frm, text='Your song:  ' + song['song_name'])
        id.pack(side=TOP)
    ...
    if song["song_id"] == 15:
        ...
        recommend = Label(frm, text='Recommended songs:')
        recommend.pack(side=TOP)
        recommend1 = Label(frm, text='Juju On That Beat - Zay Hilfigerrr & Zayion McCall')
        recommend1.pack(side=TOP)
        recommend2 = Label(frm, text="Don't Mind - Kent Jones")
        recommend2.pack(side=TOP)
    if song["song_id"] == 16:
        id = Label(frm, text='Your song:  ' + song['song_name'])
        id.pack(side=TOP)
    ...
    if song["song_id"] == 17:
        ...
        recommend = Label(frm, text='Recommended songs:')
        recommend.pack(side=TOP)
        recommend1 = Label(frm, text='2 Phones - Kevin Gates')
        recommend1.pack(side=TOP)
        recommend2 = Label(frm, text="Timmy Turner - Desiigner")
        recommend2.pack(side=TOP)
    if song["song_id"] == 18:
        id = Label(frm, text='Your song:  ' + song['song_name'])
        id.pack(side=TOP)
    ...
    if song["song_id"] == 19:
        ...
        recommend = Label(frm, text='Recommended songs:')
        recommend.pack(side=TOP)
        recommend1 = Label(frm, text='Side To Side - Ariana Grande ft. Nicki Minaj')
        recommend1.pack(side=TOP)
    ...
    if song["song_id"] == 20:
        ...
        recommend = Label(frm, text='Recommended songs:')
        recommend.pack(side=TOP)
        recommend1 = Label(frm, text='Hold You Down - DJ Khaled ft. Chris Brown')
        recommend1.pack(side=TOP)
    ...
    if song["song_id"] == 21:
        ...
        recommend = Label(frm, text='Recommended songs:')
        recommend.pack(side=TOP)
        recommend1 = Label(frm, text='Let Me Love You - DJ Snake ft. Justin Bieber')
        recommend1.pack(side=TOP)
    ...
    if song["song_id"] == 22:
        ...
        recommend = Label(frm, text='Recommended songs:')
        recommend.pack(side=TOP)
        recommend1 = Label(frm, text='Cold Water - Major Lazer ft. Justin Bieber')
        recommend1.pack(side=TOP)
        recommend2 = Label(frm, text="In The Name Of Love - Martin Garrix & Bebe Rexha")
        recommend2.pack(side=TOP)
    if song["song_id"] == 23:
        id = Label(frm, text='Your song:  ' + song['song_name'])
        id.pack(side=TOP)
    ...
    if song["song_id"] == 27:
        ...
        recommend = Label(frm, text='Recommended songs:')
        recommend.pack(side=TOP)
        recommend1 = Label(frm, text='Lego House - Ed Sheeran')
        recommend1.pack(side=TOP)
        recommend2 = Label(frm, text="Stitches - Shawn Mendes")
        recommend2.pack(side=TOP)
    if song["song_id"] == 28:
        ...
        recommend = Label(frm, text='Recommended songs:')
        recommend.pack(side=TOP)
        recommend1 = Label(frm, text="I'm Not The Only One - Sam Smith")
        recommend1.pack(side=TOP)
        recommend2 = Label(frm, text="Cold Water - Major Lazer ft. Justin Bieber")
        recommend2.pack(side=TOP)
    if song["song_id"] == 29:
        id = Label(frm, text='Your song:  ' + song['song_name'])
        id.pack(side=TOP)
        ...
        recommend1.pack(side=TOP)
        recommend2 = Label(frm, text="Lights - Ellie Goulding")
        recommend2.pack(side=TOP)
    if song["song_id"] == 30:
        id = Label(frm, text='Your song:  ' + song['song_name'])
        id.pack(side=TOP)
    ...
    if song["song_id"] == 32:
        ...
        recommend = Label(frm, text='Recommended songs:')
        recommend.pack(side=TOP)
        recommend1 = Label(frm, text='Sorry - Justin Bieber')
        recommend1.pack(side=TOP)
        recommend2 = Label(frm, text="Cold Water - Major Lazer ft. Justin Bieber")
        recommend2.pack(side=TOP)
    if song["song_id"] == 33:
        ...
        recommend1.pack(side=TOP)
        recommend2 = Label(frm, text="Sorry - Justin Bieber")
        recommend2.pack(side=TOP)
    if song["song_id"] == 34:
        id = Label(frm, text='Your song:  ' + song['song_name'])
        id.pack(side=TOP)
    ...
    if song["song_id"] == 36:
        ...
        recommend = Label(frm, text='Recommended songs:')
        recommend.pack(side=TOP)
        recommend1 = Label(frm, text='Just Give Me A Reason - P!nk ft. Nate Ruess')
        recommend1.pack(side=TOP)
    ...
    if song["song_id"] == 38:
        ...
        recommend = Label(frm, text='Recommended songs:')
        recommend.pack(side=TOP)
        recommend1 = Label(frm, text='I Took A Pill In Ibiza - Mike Posner')
        recommend1.pack(side=TOP)
    ...
    if song["song_id"] == 40:
        ...
        recommend = Label(frm, text='Recommended songs:')
        recommend.pack(side=TOP)
        recommend1 = Label(frm, text='Waiting On The World To Change - John Mayer')
        recommend1.pack(side=TOP)
        recommend2 = Label(frm, text="Daughters - John Mayer")
        recommend2.pack(side=TOP)
    if song["song_id"] == 41:
        id = Label(frm, text='Your song:  ' + song['song_name'])
        id.pack(side=TOP)
        ...
        recommend1.pack(side=TOP)
        recommend2 = Label(frm, text="Uptown Funk - Mark Ronson ft. Bruno Mars")
        recommend2.pack(side=TOP)
    if song["song_id"] == 42:
        id = Label(frm, text='Your song:  ' + song['song_name'])
        id.pack(side=TOP)
        recommend = Label(frm, text='Recommended songs:')
        recommend.pack(side=TOP)
        recommend1 = Label(frm, text='This Is What You Came For - Calvin Harris')
        recommend1.pack(side=TOP)
        recommend2 = Label(frm, text="Faded - Alan Walker")
        recommend2.pack(side=TOP)
    if song["song_id"] == 43:
        id = Label(frm, text='Your song:  ' + song['song_name'])
        id.pack(side=TOP)
    ...
    if song["song_id"] == 46:
        ...
        recommend = Label(frm, text='Recommended songs:')
        recommend.pack(side=TOP)
        recommend1 = Label(frm, text='Scars To Your Beaufitul - Alessia Cara')
        recommend1.pack(side=TOP)
        recommend2 = Label(frm, text="Side To Side - Ariana Grande ft. Nicki Minaj")
        recommend2.pack(side=TOP)
    if song["song_id"] == 47:
        ...
        recommend = Label(frm, text='Recommended songs:')
        recommend.pack(side=TOP)
        recommend1 = Label(frm, text='Locked Away - R City ft. Adam Levine')
        recommend1.pack(side=TOP)
        recommend2 = Label(frm, text="Sorry - Justin Bieber")
        recommend2.pack(side=TOP)
    if song["song_id"] == 48:
        ...
        recommend1.pack(side=TOP)
        recommend2 = Label(frm, text="Backroad Song - Granger Smith")
        recommend2.pack(side=TOP)
    if song["song_id"] == 49:
        id = Label(frm, text='Your song:  ' + song['song_name'])
        id.pack(side=TOP)
    ...
    if song["song_id"] == 50:
        ...
        recommend = Label(frm, text='Recommended songs:')
        recommend.pack(side=TOP)
        recommend1 = Label(frm, text='Cry Me A River - Justin Timberlake')
        recommend1.pack(side=TOP)
        recommend2 = Label(frm, text="Not A Bad Thing - Justin Timberlake")
        recommend2.pack(side=TOP)
    if song["song_id"] == 51:
        id = Label(frm, text='Your song:  ' + song['song_name'])
        id.pack(side=TOP)
    ...
    if song["song_id"] == 55:
        ...
        recommend = Label(frm, text='Recommended songs:')
        recommend.pack(side=TOP)
        recommend1 = Label(frm, text='Bartender - Lady Antebellum')
        recommend1.pack(side=TOP)
    ...
    if song["song_id"] == 56:
        ...
        recommend = Label(frm, text='Recommended songs:')
        recommend.pack(side=TOP)
        recommend1 = Label(frm, text='Starry Eyed - Ellie Goulding')
        recommend1.pack(side=TOP)
    ...
    if song["song_id"] == 57:
        ...
        recommend = Label(frm, text='Recommended songs:')
        recommend.pack(side=TOP)
        recommend1 = Label(frm, text='Criminal Mind - Lukas Graham')
        recommend1.pack(side=TOP)
        recommend2 = Label(frm, text="Scars To Your Beautiful - Alessia Cara")
        recommend2.pack(side=TOP)
    if song["song_id"] == 58:
    ...
    if song["song_id"] == 61:
        ...
        recommend = Label(frm, text='Recommended songs:')
        recommend.pack(side=TOP)
        recommend1 = Label(frm, text='Marvin Gaye - Charlie Puth ft. Meghan Trainor')
        recommend1.pack(side=TOP)
        recommend2 = Label(frm, text="Scars To Your Beautiful - Alessia Cara")
        recommend2.pack(side=TOP)
    if song["song_id"] == 62:
        ...
        recommend = Label(frm, text='Recommended songs:')
        recommend.pack(side=TOP)
        recommend1 = Label(frm, text='Blank Space - Taylor Swift')
        recommend1.pack(side=TOP)
    ...
    if song["song_id"] == 63:
        ...
        recommend = Label(frm, text='Recommended songs:')
        recommend.pack(side=TOP)
        recommend1 = Label(frm, text='Summer - Calvin Harris')
        recommend1.pack(side=TOP)
        recommend2 = Label(frm, text="Side To Side - Ariana Grande ft. Nicki Minaj")
        recommend2.pack(side=TOP)
    if song["song_id"] == 64:
    ...
    if song["song_id"] == 68:
        ...
        recommend = Label(frm, text='Recommended songs:')
        recommend.pack(side=TOP)
        recommend1 = Label(frm, text='Shake It Off - Taylor Swift')
        recommend1.pack(side=TOP)
        recommend2 = Label(frm, text="Let Me Love You - DJ Snake ft. Justin Bieber")
        recommend2.pack(side=TOP)
    if song["song_id"] == 69:
        id = Label(frm, text='Your song:  ' + song['song_name'])
        id.pack(side=TOP)
    ...
    if song["song_id"] == 72:
        ...
        recommend = Label(frm, text='Recommended songs:')
        recommend.pack(side=TOP)
        recommend1 = Label(frm, text='Titanium - David Guetta')
        recommend1.pack(side=TOP)
        recommend2 = Label(frm, text="Blank Space - Taylor Swift")
        recommend2.pack(side=TOP)
    if song["song_id"] == 73:
    ...
    if song["song_id"] == 76:
        ...
        recommend = Label(frm, text='Recommended songs:')
        recommend.pack(side=TOP)
        recommend1 = Label(frm, text='Mercy - Shawn Mendes')
        recommend1.pack(side=TOP)
        recommend2 = Label(frm, text="Into You - Ariana Grande")
        recommend2.pack(side=TOP)
    if song["song_id"] == 77:
        id = Label(frm, text='Your song:  ' + song['song_name'])
        id.pack(side=TOP)
        ...
        recommend1.pack(side=TOP)
        recommend2 = Label(frm, text="One Call Away - Charlie Puth")
        recommend2.pack(side=TOP)
    if song["song_id"] == 78:
        id = Label(frm, text='Your song:  ' + song['song_name'])
        id.pack(side=TOP)
    ...
    if song["song_id"] == 81:
        ...
        recommend = Label(frm, text='Recommended songs:')
        recommend.pack(side=TOP)
        recommend1 = Label(frm, text='In The Name of Love - Martin Garrix')
        recommend1.pack(side=TOP)
    ...
    if song["song_id"] == 84:
        ...
        recommend = Label(frm, text='Recommended songs:')
        recommend.pack(side=TOP)
        recommend1 = Label(frm, text='Thinking Out Loud - Ed Sheeran')
        recommend1.pack(side=TOP)
        recommend2 = Label(frm, text="I'm Not the Only One - Sam Smith")
        recommend2.pack(side=TOP)
    if song["song_id"] == 85:
        id = Label(frm, text='Your song:  ' + song['song_name'])
        id.pack(side=TOP)
    ...
    if song["song_id"] == 87:
        ...
        recommend = Label(frm, text='Recommended songs:')
        recommend.pack(side=TOP)
        recommend1 = Label(frm, text="We Don't Talk Anymore - Charlie Puth")
        recommend1.pack(side=TOP)
        recommend2 = Label(frm, text="This Is What You Came For Lyrics - Calvin Harris ft. Rihanna")
        recommend2.pack(side=TOP)
    if song["song_id"] == 88:
        id = Label(frm, text='Your song:  ' + song['song_name'])
        id.pack(side=TOP)
        ...
        recommend1.pack(side=TOP)
        recommend2 = Label(frm, text="Mirrors - Justin Timberlake")
        recommend2.pack(side=TOP)
    if song["song_id"] == 89:
        id = Label(frm, text='Your song:  ' + song['song_name'])
        id.pack(side=TOP)
        recommend = Label(frm, text='Recommended songs:')
        recommend.pack(side=TOP)
        recommend1 = Label(frm, text='Timmy Turner - Desiigner')
        recommend1.pack(side=TOP)
        recommend2 = Label(frm, text="Treat You Better - Shawn Mendes")
        recommend2.pack(side=TOP)
    if song["song_id"] == 90:
        id = Label(frm, text='Your song:  ' + song['song_name'])
        id.pack(side=TOP)
        recommend = Label(frm, text='Recommended songs:')
        recommend.pack(side=TOP)
        recommend1 = Label(frm, text='Just The Way You Are lyrics - Bruno Mars')
        recommend1.pack(side=TOP)
        recommend2 = Label(frm, text="Thinking out Loud - Ed Sheeran")
        recommend2.pack(side=TOP)
    if song["song_id"] == 91:
        id = Label(frm, text='Your song:  ' + song['song_name'])
        id.pack(side=TOP)
        recommend = Label(frm, text='Recommended songs:')
        recommend.pack(side=TOP)
        recommend1 = Label(frm, text='Cheap Thrills - Sia ft. Sean Paul')
        recommend1.pack(side=TOP)
    ...
    if song["song_id"] == 93:
        ...
        recommend1.pack(side=TOP)
        recommend2 = Label(frm, text="This Is What You Came For - Calvin Harris ft. Rihanna")
        recommend2.pack(side=TOP)
    if song["song_id"] == 94:
        id = Label(frm, text='Your song:  ' + song['song_name'])
        id.pack(side=TOP)
        ...
        recommend1.pack(side=TOP)
        recommend2 = Label(frm, text="Do You Mind - DJ Khaled ft Chris Brown Nicki Minaj")
        recommend2.pack(side=TOP)
    if song["song_id"] == 95:
        id = Label(frm, text='Your song:  ' + song['song_name'])
        id.pack(side=TOP)
    ...
    if song["song_id"] == 96:
        ...
        recommend = Label(frm, text='Recommended songs:')
        recommend.pack(side=TOP)
        recommend1 = Label(frm, text='Justin Bieber - What Do You Mean')
        recommend1.pack(side=TOP)
        recommend2 = Label(frm, text="Shawn Mendes - Treat You Better")
        recommend2.pack(side=TOP)
    if song["song_id"] == 97:
        id = Label(frm, text='Your song:  ' + song['song_name'])
        id.pack(side=TOP)
        recommend = Label(frm, text='Recommended songs:')
        recommend.pack(side=TOP)
        recommend1 = Label(frm, text='Love Yourself - Justin Bieber')
        recommend1.pack(side=TOP)
        recommend2 = Label(frm, text="Let me love you -DJ Snake _ Justin Bieber")
        recommend2.pack(side=TOP)
    if song["song_id"] == 98:
        id = Label(frm, text='Your song:  ' + song['song_name'])
        id.pack(side=TOP)
        ...
        recommend1.pack(side=TOP)
        recommend2 = Label(frm, text="Work from Home - Fifth Harmony ft. Ty Dolla $")
        recommend2.pack(side=TOP)
    if song["song_id"] == 99:
        id = Label(frm, text='Your song:  ' + song['song_name'])
        id.pack(side=TOP)
